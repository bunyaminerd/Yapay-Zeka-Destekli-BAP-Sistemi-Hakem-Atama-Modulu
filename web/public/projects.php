...
try {
    ...
    $stmt = $pdo->prepare("SELECT id, title, keywords FROM projects ORDER BY id DESC LIMIT :limit OFFSET :offset");
...
<head>
    ...
    <title>BAP Sistemi - Projeler</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="content-card">
                        <h2 class="card-title"><i class="fas fa-file-alt"></i> Proje Listesi</h2>
        ...
        const applyTheme = (theme) => {
            ...
            if (theme === 'dark') {
                ...
                projectItems.forEach(item => {
                    item.style.backgroundColor = 'rgba(32, 32, 32, 0.8)';
                    item.style.color = '#ffffff';
                    item.style.borderLeftColor = '#4776E6';
                });
